...
// 1) ราดข้าวกะเพรา group: เนื้อ 1-3 (รวมเนื้อพื้นฐาน + พรีเมี่ยม +10) + ไข่ +5 + เพิ่มพิเศษ + กับข้าว +30
const OPT_KAPRAO = () => ([
  { kind: 'required',
...
// 1b) ราดข้าว ผัดผัก (ไฟแดง): เนื้อ/ผัก 1-3 + ไข่ +5 + เพิ่มพิเศษ + กับข้าว
const OPT_FAIDAENG = () => ([
  { kind: 'required',
...
// 2d) ต้มยำ: เนื้อ 1-3 (พื้นฐาน + พรีเมี่ยม +10) + เพิ่มพิเศษ +20
