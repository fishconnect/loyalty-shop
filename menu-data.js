...
// 1) ราดข้าวกะเพรา group: เนื้อ 0-3 + พิเศษ +10 + ไข่ +5 + เพิ่มพิเศษ + กับข้าว +30
const OPT_KAPRAO = () => ([
...
// 1b) ราดข้าว ผัดผัก (ไฟแดง): เนื้อ/ผัก 0-3 + +10 + ไข่ +5 + เพิ่มพิเศษ + กับข้าว
const OPT_FAIDAENG = () => ([
  { kind: 'addOn', label: 'เลือกเนื้อ/ผัก (ไม่บังคับ · เลือกได้สูงสุด 3 อย่าง)', min: 0, max: 3, priceEach: 0,
...
// 2) ข้าวผัด: เนื้อ 0-1 (ไม่บังคับ) + +10 (มีหมูกรอบ) + ไข่ +5 + เพิ่มพิเศษ
const OPT_KAOPAD = () => ([
...
// 2b) ราดข้าว-ไข่เจียว: เนื้อ 0-1 + +10 (3 ตัว ไม่มีหมูกรอบ) + เพิ่มพิเศษ + กับข้าว
...
// 2c) มาม่าผัดขึ้เมา / ผัดมาม่า: เนื้อ 0-1 (3 ตัว ไม่มีแหนม) + +10 + ไข่ +5 + เพิ่มพิเศษ
...
// 2d) ต้มยำ: เนื้อ 0-3 + +10 (กุ้ง/ปลาหมึก/รวมมิตร) + เพิ่มพิเศษ +20
...
// 3) ผัดซีอิ๊ว: เนื้อ 0-1 + +10 (มีหมูกรอบ) + เลือกเส้น (จำเป็น) + เพิ่มพิเศษ
const OPT_PADSEEW = () => ([
  { kind: 'addOn', label: 'เลือกเนื้อ (ไม่บังคับ)', min: 0, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'หมูสับ', 'ไก่'] },
  { kind: 'addOn', label: 'เพิ่มของพิเศษ (+10)', min: 0, max: 99, priceEach: 10,
...
// 4) ราดหน้า: เนื้อ 0-1 + +10 (ไม่มีหมูกรอบ) + เลือกเส้น (จำเป็น) + เพิ่มพิเศษ
const OPT_RADNAA = () => ([
  { kind: 'addOn', label: 'เลือกเนื้อ (ไม่บังคับ)', min: 0, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'หมูสับ', 'ไก่'] },
  { kind: 'addOn', label: 'เพิ่มของพิเศษ (+10)', min: 0, max: 99, priceEach: 10,
...
// 5) สุกี้: เนื้อ 0-1 (ไม่บังคับ) + +5 (รวมมิตร/กุ้ง/ปลาหมึก) + เพิ่มพิเศษ
const OPT_SUKI = () => ([
  { kind: 'addOn', label: 'เลือกเนื้อ (ไม่บังคับ)', min: 0, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'ไก่'] },
