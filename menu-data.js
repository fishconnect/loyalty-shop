...
// 1) ราดข้าวกะเพรา group: เนื้อ max 3 + พิเศษ +10 (6 ตัว) + ไข่ +5
const OPT_KAPRAO = () => ([
...
// 2) ข้าวผัด: เนื้อ max 1 (4 ตัว — มีแหนม) + +10 (มีหมูกรอบ) + ไข่ +5
const OPT_KAOPAD = () => ([
...
// 2b) ราดข้าว-ไข่เจียว: เนื้อ max 1 (หมูสับ/ไก่สับ/แหนม) + +10 (3 ตัว ไม่มีหมูกรอบ) — ไม่มีไข่
