...
// 1) ราดข้าวกะเพรา group: เนื้อ 0-3 (ไม่บังคับ) + พิเศษ +10 (6 ตัว) + ไข่ +5 + เพิ่มพิเศษ
const OPT_KAPRAO = () => ([
...
// 1b) ราดข้าว ผัดผัก (ไฟแดง): เนื้อ/ผัก 0-3 (7 ตัวเลือก) + +10 + ไข่ +5 + เพิ่มพิเศษ
const OPT_FAIDAENG = () => ([
...
// 2b) ราดข้าว-ไข่เจียว: เนื้อ 0-1 + +10 (3 ตัว ไม่มีหมูกรอบ) + เพิ่มพิเศษ
...
// 6) เมนูพิเศษ: ไข่ +5 + เพิ่มพิเศษ
const OPT_EGG_ONLY = () => ([
  { kind: 'addOn', label: 'เพิ่มไข่ (+5)', min: 0, max: 99, priceEach: 5, choices: [..._EGGS_5] },
  OPT_EXTRA()
]);

// 6b) ยำ / ทานเล่น (มีแค่เพิ่มพิเศษ)
...
window.MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ym-005', name: 'ราดข้าว ยำไข่เจียว',     price: 40, optionGroups: OPT_EXTRA_ONLY() },
      { id: 'ym-006', name: 'ราดข้าว ยำไข่ดาว',       price: 40, optionGroups: OPT_EXTRA_ONLY() },
    ]
  },
  {
    cat: "ทานเล่น / สเต๊ก",
