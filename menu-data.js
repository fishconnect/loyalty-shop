...
const OPT_EXTRA = () => ({ kind: 'addOn', label: 'เพิ่ม พิเศษ (+10)', min: 0, max: 1, priceEach: 10, choices: ['พิเศษ'] });
// 🆕 เพิ่มพิเศษ +20 — ต้มยำ/ต้มจืด
const OPT_EXTRA_20 = () => ({ kind: 'addOn', label: 'เพิ่ม พิเศษ (+20)', min: 0, max: 1, priceEach: 20, choices: ['พิเศษ'] });
// 🆕 กับข้าว +30 — สำหรับเมนูข้าว
const OPT_KAB_KAOW_30 = () => ({ kind: 'addOn', label: 'เพิ่ม กับข้าว (+30)', min: 0, max: 1, priceEach: 30, choices: ['กับข้าว'] });
// 🆕 กับข้าว +10 — สำหรับยำไข่เจียว/ยำไข่ดาว (ราคาถูกกว่า)
const OPT_KAB_KAOW_10 = () => ({ kind: 'addOn', label: 'เพิ่ม กับข้าว (+10)', min: 0, max: 1, priceEach: 10, choices: ['กับข้าว'] });

// 1) ราดข้าวกะเพรา group: เนื้อ 1-3 (จำเป็น) + พิเศษ +10 + ไข่ +5 + เพิ่มพิเศษ + กับข้าว +30
const OPT_KAPRAO = () => ([
  { kind: 'required', label: 'เลือกเนื้อ (เลือกอย่างน้อย 1 · สูงสุด 3 อย่าง)', min: 1, max: 3, priceEach: 0,
...
// 1b) ราดข้าว ผัดผัก (ไฟแดง): เนื้อ/ผัก 1-3 + +10 + ไข่ +5 + เพิ่มพิเศษ + กับข้าว
const OPT_FAIDAENG = () => ([
  { kind: 'required', label: 'เลือกเนื้อ/ผัก (เลือกอย่างน้อย 1 · สูงสุด 3 อย่าง)', min: 1, max: 3, priceEach: 0,
...
// 2) ข้าวผัด: เนื้อ 1 (จำเป็น) + +10 (มีหมูกรอบ) + ไข่ +5 + เพิ่มพิเศษ
const OPT_KAOPAD = () => ([
...
// 2b) ราดข้าว-ไข่เจียว: เนื้อ 1 (จำเป็น) + +10 (3 ตัว ไม่มีหมูกรอบ) + เพิ่มพิเศษ + กับข้าว
...
// 2c) มาม่าผัดขึ้เมา / ผัดมาม่า: เนื้อ 1 (จำเป็น) + +10 + ไข่ +5 + เพิ่มพิเศษ
...
// 2d) ต้มยำ: เนื้อ 1-3 (จำเป็น) + +10 (กุ้ง/ปลาหมึก/รวมมิตร) + เพิ่มพิเศษ +20
...
// 3) ผัดซีอิ๊ว: เนื้อ 1 (จำเป็น) + +10 (มีหมูกรอบ) + เลือกเส้น (จำเป็น) + เพิ่มพิเศษ
const OPT_PADSEEW = () => ([
  { kind: 'required', label: 'เลือกเนื้อ', min: 1, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'หมูสับ', 'ไก่'] },
  { kind: 'addOn', label: 'เพิ่มของพิเศษ (+10)', min: 0, max: 99, priceEach: 10,
...
// 4) ราดหน้า: เนื้อ 1 (จำเป็น) + +10 (ไม่มีหมูกรอบ) + เลือกเส้น (จำเป็น) + เพิ่มพิเศษ
const OPT_RADNAA = () => ([
  { kind: 'required', label: 'เลือกเนื้อ', min: 1, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'หมูสับ', 'ไก่'] },
  { kind: 'addOn', label: 'เพิ่มของพิเศษ (+10)', min: 0, max: 99, priceEach: 10,
...
// 5) สุกี้: เนื้อ 1 (จำเป็น) + +5 (รวมมิตร/กุ้ง/ปลาหมึก) + เพิ่มพิเศษ
const OPT_SUKI = () => ([
  { kind: 'required', label: 'เลือกเนื้อ', min: 1, max: 1, priceEach: 0,
    choices: ['หมูชิ้น', 'ไก่'] },
...
const OPT_YAM_RICE = () => ([ OPT_EXTRA(), OPT_KAB_KAOW_10() ]);
...
// 10b) ชานมไต้หวั่น: 4 ตัวเลือก +5 each
